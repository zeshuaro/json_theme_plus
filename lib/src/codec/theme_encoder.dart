  ...
  static Map<String, dynamic>? encodeThemeData(ThemeData? value) {
    ...
    if (value != null) {
      result = <String, dynamic>{
        ...
        'cardThemeData': encodeCardTheme(value.cardThemeData),
        ...
        'dialogThemeData': encodeDialogTheme(value.dialogThemeData),
        'disabledColor': encodeColor(value.disabledColor),
        'dividerColor': encodeColor(value.dividerColor),
        ...
        'tabBarThemeData': encodeTabBarTheme(value.tabBarThemeData),
